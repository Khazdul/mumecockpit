...
local function serialize()
    ...
    local payload = {
        ...
        tp_progress    = level_progress.compute_tp_progress(c.xp, c.tp, c.race),
        xp_progress_baseline = level_progress.compute_xp_baseline(c.xp,
                                  state.run and state.run.xp or nil),
        tp_progress_baseline = level_progress.compute_tp_baseline(c.xp, c.tp,
                                  state.run and state.run.tp or nil, c.race),
